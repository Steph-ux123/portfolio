...
REM
REM Generated by Vivado on Sat Aug 10 07:54:16 -0400 2024
...
echo "xvlog --incr --relax -L uvm -prj LineBuffer_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj LineBuffer_tb_vlog.prj -log xvlog.log
